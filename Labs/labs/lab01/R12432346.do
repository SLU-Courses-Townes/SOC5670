...
set more off
clear
infile using "R12432346.dct", using("U:\spatdemo20\data\lab01\R12432346_SL140.txt")
...
export excel FIPS dp cdp sdp ai e wht blk lat oth tot pwht pblk using "U:\spatdemo20\data\lab01\part01.xls", firstrow(variables) nolabel replace, 

*Create a new Stata datbase
save "U:\spatdemo20\data\lab01\stl_part01.dta", replace
