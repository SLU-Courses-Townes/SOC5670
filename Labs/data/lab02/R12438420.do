...
set more off
clear
infile using "R12438420.dct", using("F:\SOC5670\Labs\data\lab02\R12438420_SL140.txt")
...
export excel FIPS theil edtot pov nhi mhi  using "F:\SOC5670\Labs\data\lab02\part02.xls", firstrow(variables) nolabel replace, 

save "F:\SOC5670\Labs\data\lab02\stl_part02.dta", replace
