...
set more off
clear 
infile using "R12459585.dct", using("F:\SOC5670\Assignments\Homework01\data\data02\R12459585_SL140.txt")
...
export excel FIPS dp cdp sdp ai e wht blk lat oth tot pwht pblk using "F:\SOC5670\Assignments\Homework01\data\data02\part01.xls", firstrow(variables) nolabel replace, 

*Create a new Stata datbase
save "F:\SOC5670\Assignments\Homework01\data\data02\hw01_part01.dta", replace
